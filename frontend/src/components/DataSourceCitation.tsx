      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
          ...
          <div>
            ...
            <p className="mt-1">
              <strong itemProp="dateModified">Last major update:</strong> January 2026
            </p>
          </div>
          ...
          <div>
            ...
            <blockquote className="border-l-4 border-gray-300 pl-4 my-2 italic" itemProp="citation">
