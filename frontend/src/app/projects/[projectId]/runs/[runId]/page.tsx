...
function RunPageContent() {
  ...
  useEffect(() => {
    ...
    if (exportTitleRef.current !== null) {
      document.title = exportTitleRef.current;
  ...
  return (
    <>
      ...
      <div className="card stack accent-green">
        <div className="row" style={{ justifyContent: "space-between", marginBottom: "8px" }}>
          <div>
              <h2 style={{ margin: 0 }}>🧠 Retrieval Framework (Guidelines for Query Statement Generation)</h2>
      ...
      <div className="export-only" style={{ display: "block" }}>
        ...
        <div className="container stack export-page">
          ...
          <div className="card stack">
            <h2 style={{ margin: 0 }}>🧾 Research Description</h2>
            <div className="muted">Final research description</div>
            <div
              style={{
                background: "#f8fafc",
                border: "1px solid #e5e7eb",
          ...
          <div className="card stack">
            <h2 style={{ margin: 0 }}>🧩 Retrieval Framework</h2>
            <div className="muted">Final retrieval framework</div>
            <div
              style={{
                background: "#f8fafc",
                border: "1px solid #e5e7eb",
